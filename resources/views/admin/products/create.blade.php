        ...
        <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-alt">
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a class="link-fx" href="/admin/categories/show/{{ $alias }}">{{$categoryTitle->title[App::currentLocale()]}}</a>
            </li>
            <li class="breadcrumb-item" aria-current="page">
            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-xl-5">
                ...
                <div class="block block-rounded">
                    ...
                    <div class="mb-4 mt-4">
                        <label class="form-label" for="product-photo-file">{{__('admin.products.fileinput-image')}} @error('photo')<span style="vertical-align: super;" class="badge bg-warning"><i class="fa fa-exclamation-circle"></i> {{$message}}</span>@enderror</label>
