  ...
  <div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
          <h3 class="block-title">{{__('admin.navi.banner-type')}}</h3>
        </div>
        <div class="block-content block-content-full">
          <form action="{{route('banners-submit-type')}}" method="POST" >
            @csrf
            <div class="row">
              <div class="col-lg-4">
                <p class="fs-sm text-muted">
                    {{__('admin.navi.banner-type-text')}}
                ...
                <div class="row items-push">
                    ...
                    @foreach ($types as $key => $type)
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="radio" class="form-check-input" id="banner-type-{{$key}}" name="type" value="{{$key}}">
                            <label class="form-check-label" for="banner-type-{{$key}}">
