...
@else
    <div class="mb-4 mt-4">
        <label class="form-label" for="product-image-file">{{__('fileinput-image')}} @error('image')<span style="vertical-align: super;" class="badge bg-warning"><i class="fa fa-exclamation-circle"></i> {{$message}}</span>@enderror</label>
