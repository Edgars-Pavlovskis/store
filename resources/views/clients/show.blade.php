                ...
                @foreach ($clients as $client)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-alt-secondary" title="{{ __('admin.tooltips.delete') }}"
                            onclick="Livewire.dispatch('confirmDeleteExternal', {
                                itemId: '{{ $client->id }}',
                                itemName: @json($client->name . ' [' . $client->email . ']'),
                                model: 'User',
                                parent: ''
                            })">
