                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" class="pc-w620-padding-0-0-0-0" align="center" style="padding: 0px 20px 0px 20px;">
                      <div class="pc-font-alt pc-w620-fontSize-30 pc-w620-lineHeight-40" style="line-height: 90%; letter-spacing: -0.03em; font-family: 'Hanken Grotesk', Arial, Helvetica, sans-serif; font-size: 30px; font-weight: bold; font-variant-ligatures: normal; color: #fff29f; text-align: center; text-align-last: center;">
                       <div><span>Jauns ziņojums no web lapas!</span>
                       </div>
                      </div>
                     </td>
                    </tr>
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w620-padding-28-28-28-28" style="padding: 40px 40px 0px 40px; border-radius: 0px; background-color: #ffffff;" bgcolor="#ffffff">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td class="pc-w620-spacing-0-0-24-0" align="left" style="padding: 0px 0px 32px 0px;">
                               ...
                               <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0;">
                                <tr>
                                 <td valign="top" align="left" style="padding: 0px 0px 0px 0px;">
                                  <div class="pc-font-alt pc-w620-fontSize-15px" style="line-height: 121%; letter-spacing: -0.2px; font-family: 'Hanken Grotesk', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; font-variant-ligatures: normal; color: #99959b; text-align: left; text-align-last: left;">
                                        <div style="margin-bottom:5px;"><span><b>Vārds:</b> </span><span style="font-weight: 600;font-style: normal;color: rgb(83, 51, 93);"> {{$name}} </span></div>
                                        <div style="margin-bottom:5px;"><span><b>Tālruņa numurs:</b> </span><span style="font-weight: 600;font-style: normal;color: rgb(83, 51, 93);"> {{$phone}} </span></div>
                                        <div style="margin-bottom:5px;"><span><b>E-pasta adrese:</b> </span><span style="font-weight: 600;font-style: normal;color: rgb(83, 51, 93);"> {{$email}} </span></div>
                                        <div style="margin-bottom:5px;"><span><b>Ziņojums:</b> </span><span style="font-weight: 600;font-style: normal;color: rgb(83, 51, 93);"> {{$msg}} </span></div>
                                  </div>
                                 </td>
                                </tr>
                               </table>
